...
public class CashInAdapter extends RecyclerView.Adapter<CashInAdapter.ViewHolder> {
    ...
    public CashInAdapter(int intendedBookID,ViewModel viewModel,Context context) {
    ...
    public void setCash(List<BookModel.Cash> cash) {
        ...
        for (BookModel.Cash cashEntry : cash) {
            if ("in".equalsIgnoreCase(cashEntry.getInOrOut()) && cashEntry.getBookID() == intendedBookID) {
    ...
    @NonNull
    @Override
    public CashInAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
